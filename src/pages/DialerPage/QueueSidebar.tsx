...
import { CalendarClock, CheckCircle2, Flame, PhoneCall, Snowflake, Ban } from 'lucide-react'
...
function DisplaySection({ label, icon, companies, renderMeta, sort }: DisplaySectionProps) {
  if (companies.length === 0) return null
...
export function QueueSidebar() {
  const { dialerQueue, dialerBuckets, allBuckets, dialerCompany, dialerJumpTo, callLogsByCompany, assignedCompanies } = useDialerContext()
